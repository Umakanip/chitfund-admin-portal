...
try {
    ...
    // Clear all existing allocations first
    ...
    // Allocate members to schedules using round-robin
    ...
    // Build summary with member names
    $summary = [];
    ...
    sendResponse(true, [
        'message' => "Re-allocated {$allocated} month(s) to {$memberCount} member(s)",
        'summary' => $summary
